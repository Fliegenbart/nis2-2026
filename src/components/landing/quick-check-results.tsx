      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/50 overflow-hidden">
            {/* Score header */}
            <div className="bg-slate-900/80 text-center py-10">
            ...
            <div className="p-6 space-y-3">
              {questions.map((question) => (
                <div
                  key={question.id}
                  className="flex items-center gap-3 border border-slate-800 bg-slate-900/50 rounded-lg p-3"
                >
            ...
            <div className="relative">
              ...
              <div className="relative flex flex-col items-center gap-4 px-6 pb-8 pt-16">
                ...
                <button
                  onClick={onUnlock}
                  className="inline-flex items-center justify-center bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold rounded-lg px-6 py-3 transition-colors"
                >
                  {t("unlockCta")}
                </button>
              </div>
